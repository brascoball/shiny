...
(function () {
  ...
  (function () {
    ...
    this.getTestSnapshotUrl = function () {
      return window.location.protocol + "//" + window.location.hostname + ":" + window.location.port + window.location.pathname + "session/" + encodeURIComponent(this.config.sessionId) + "/dataobj/shinyTestSnapshot?w=" + encodeURIComponent(this.config.workerId);
    };
